    ...
    <div className="product-container">
        ...
        <div className="flex-1 flex flex-col">
          <div className="flex justify-between items-start gap-5 flex-wrap pb-6 ">
              <div className="flex flex-col gap-3">
                <p className="text-[28px] text-secondry font-semibold">{product.title}</p>
                <Link 
              ...
              <div className="flex items-center gap-3 ">
                ...
                <div className="bg-white-200 rounded-10 p-2">
                  <Image
          ...
          <div className="my-7 flex flex-col gap-5">
             <div className="flex gap-5 flex-wrap ">
                <PriceInfoCard
                 title='Current Price'
                 iconSrc='/assets/icon/price-tag.svg'
                 value={`${product.currency} ${formatNumber(product.currentPrice)}`}
                />
                <PriceInfoCard
                 title='Average Price'
                 iconSrc='/assets/icon/chart.svg'
                 value={`${product.currency} ${formatNumber(product.averagePrice)}`}
                />
                <PriceInfoCard
                 title='Highest Price'
                 iconSrc='/assets/icon/arrow-up.svg'
                 value={`${product.currency} ${formatNumber(product.highestPrice)}`}
                />
                <PriceInfoCard
                 title='Lowest Price'
                 iconSrc='/assets/icon/arrow-down.svg'
      ...
      <div className="flex flex-col gap-16 ">
        <div className="flex flex-col gap-5">
           <h1 className="text-2xl text-secondry font-semibold">
            Product Description 
           </h1>
           <div className="flex flex-col gap-4">
